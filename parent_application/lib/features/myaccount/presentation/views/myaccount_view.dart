...
//         title: Text("الملف الشخصي", style: Theme.of(context).textTheme.headlineMedium,),
//         actions: [
...
//                 child: ClipRRect(
//                   borderRadius: BorderRadius.circular(100), child: Image.asset('assets/images/profileimage.jpg'),)
//                 ),
//                 const SizedBox(height: 10),
//                  Text(
//                 "نورة",
//                 style: Theme.of(context).textTheme.bodyMedium?.copyWith(
//                   fontWeight: FontWeight.bold,  // Make "نورة" bold
//                   fontSize: 24,                 // Set larger font size for "نورة"
//                 ),
//               ),
//                 Text(
//                 "noramohamed@gmail.com",
//                 style: Theme.of(context).textTheme.bodyMedium?.copyWith(
//                   fontWeight: FontWeight.w300,  // Make email text lighter
//                 ),
//               ),
...
//                   child: const Text("تعديل"),  style: ElevatedButton.styleFrom(
//                     backgroundColor: AppColors.primaryColor, // Button background color
//                     foregroundColor: const Color(0xFF053A21),            // Text color
...
//                 const SizedBox(height: 10),
//                 //menu
//                 myaccountMenuWidget(title: "إعدادات", icon:Icons.settings  ,onPressed: (){},),
//                 myaccountMenuWidget(title: "تسجيل خروج", icon:Icons.exit_to_app, textColor: Colors.red, endIcon: false  ,onPressed: (){},),
...
//         height: 30,
//         decoration:
//         BoxDecoration(borderRadius: BorderRadius.circular(100), color: Colors.lightBlue.withOpacity(0.1) ),
//         child: Icon(icon),
//       ),
...
//         height: 30,
//         decoration:
//         BoxDecoration(borderRadius: BorderRadius.circular(100), color: Colors.grey.withOpacity(0.1)),
